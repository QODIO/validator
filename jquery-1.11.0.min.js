...
!((a, b) => {"object"==typeof module&&"object"==typeof module.exports?module.exports=a.document?b(a,!0):a => {if(!a.document)throw new Error("jQuery requires a window with a document");return b(a)}:b(a)})("undefined"!=typeof window?window:this,(a, b) => {
  var c=[];
  var d=c.slice;
  var e=c.concat;
  var f=c.push;
  ...
  }}),n.each(["height","width"],(a, b) => {n.cssHooks[b]={get(a, c, d) {return c?0===a.offsetWidth&&Pb.test(n.css(a,"display"))?n.swap(a,Sb,() => Zb(a,b,d)):Zb(a,b,d):void 0;},set(a, c, d) {var e=d&&Jb(a);return Xb(a,c,d?Yb(a,b,d,l.boxSizing()&&"border-box"===n.css(a,"boxSizing",!1,e),e):0)}}}),l.opacity||(n.cssHooks.opacity={get(a, b) {return Ob.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?.01*parseFloat(RegExp.$1)+"":b?"1":""},set(a, b) {
    var c=a.style;
  ...
  }},$b.prototype.init.prototype=$b.prototype,$b.propHooks={_default:{get(a) {var b;return null==a.elem[a.prop]||a.elem.style&&null!=a.elem.style[a.prop]?(b=n.css(a.elem,a.prop,""),b&&"auto"!==b?b:0):a.elem[a.prop]},set(a) {n.fx.step[a.prop]?n.fx.step[a.prop](a):a.elem.style&&(null!=a.elem.style[n.cssProps[a.prop]]||n.cssHooks[a.prop])?n.style(a.elem,a.prop,a.now+a.unit):a.elem[a.prop]=a.now}}},$b.propHooks.scrollTop=$b.propHooks.scrollLeft={set(a) {a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}},n.easing={linear(a) {return a},swing(a) {return.5-Math.cos(a*Math.PI)/2}},n.fx=$b.prototype.init,n.fx.step={};
  var _b;
  var ac;
