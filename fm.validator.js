/**
 * Validator v1.3 - copyright 2013 Faroe Media
 * All rights reserved
 * No use of this code is allowed
 * Any use of this code is prohibited and will be prosecuted
 * 
 * input[type=text]
 * 	data-required
 * 	data-required-if=element
 * 	data-min=0-9
 * 	data-max=0-9
 * 	data-type=email,url,number,digits
 * 	data-error-position=before,after,before parentelement,after parentelement
 * 
 * input[type=password]
 * 	data-required
 * 	data-required-if=element
